...
} from "../../../../../modules/DataManagement/components/DataDimensionSelector/components/ProgramSelector";
...
export function ProgramDimensionSelector() {
    ...
    const [programSelection, setProgramSelection] = useRecoilState(DimensionState("program"));
