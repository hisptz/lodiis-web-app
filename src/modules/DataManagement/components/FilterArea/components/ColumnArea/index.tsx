...
import { ColumnConfig } from "../../../../../../shared/interfaces/metadata";
...
export function ColumnArea() {
	...
	return (
		<>
			<Button onClick={showModal} icon={<IconLayoutColumns24 />}>
				{i18n.t("Columns")}
			</Button>
			<ColumnModal
...
function ColumnSelector({ columns }: { columns: ColumnConfig[] }) {
	...
	return (
		<div className="column gap-8">
			<ButtonStrip>
				<Button onClick={onAllClick("check")}>
					{i18n.t("Check all")}
				</Button>
				<Button onClick={onAllClick("uncheck")}>
					{i18n.t("Uncheck all ")}
				</Button>
			</ButtonStrip>
