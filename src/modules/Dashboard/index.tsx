...
export function DashboardRouting() {
	...
	const firstProgram: ProgramConfig | undefined = head(
		programs as ProgramConfig[],
	);
	...
	return (
		<Navigate
			to={`/dashboard/${firstProgram?.id}?program=${firstProgram.id}`}
		/>
	);
}
		...
		<KBProgramSync>
			...
			>
				{visualizations?.map((visualization) => (
					<div
						key={`${visualization.id}-visualization-container`}
						style={{
							gridColumn: `auto / span ${visualization.span}`,
						}}
					>
